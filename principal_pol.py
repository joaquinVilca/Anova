# principal_pol.py
# MENU MAESTRO para regresion polinomial.
# Reutiliza: matriz, inversa, modelo_opt, anova, hipotesis, tabla_f
# Nuevos:    vandermonde (construir X), constructor (tipo="pol")
...
def ss_secuencial(x, y, grado_max):
    ...
    for k in range(2, grado_max + 1):
        ...
        F   = SS / CME
        fc  = tabla_f.f_critico(1, r_f["gl_err"], 0.05)
...
def menu_principal():
    ...
    while True:
        ...
        x, y = util_datos.pedir_xy(x_mem, y_mem, X_DEF, Y_DEF, es_matriz=False)
        x_mem = x
        y_mem = y
        ...
        if op in ["1", "3"]:
            ...
            print("BETA:")
            et = vandermonde.etiquetas_pol(k)
